...
obj_Int (*PRODUCT) (obj_Int, obj_Int);       /* Introduced */
obj_Int (*QUOTIENT) (obj_Int, obj_Int);       /* Introduced */
...
obj_Int Int_method_PRODUCT(obj_Int this, obj_Int other);
obj_Int Int_method_QUOTIENT(obj_Int this, obj_Int other);
